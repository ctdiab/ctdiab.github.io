...
# About
I am Charles Diab, and I am a technical writer with over 13 years of experience. I am a critical thinker, I have a disciplined work ethic, I am self-motivated, and I am willing to learn, whether on the job or in life. My experience includes a variety of writing tools, including Adobe InDesign, FrameMaker, RoboHelp, Microsoft Word, Ixiasoft CCMS, and GitHub, as well as different style guidelines, including the Chicago Manual of Style and the Microsoft Writing Style Guide. In addition to rich text editors, I have written documentation in HTML, XML, and Markdown.\
When I am not writing technical documentation, I enjoy studying animation, reading classic fiction (such as *Fahrenheit 451* and *A Confederacy of Dunces*), playing video games, playing in sessions of Dungeons & Dragons with my wife and friends, and taking care of my daughter.
## Animation Portfolio
In addition to my career as a technical writer, I drew cartoons officially during my time at Arizona State University and as a hobby throughout my life. I created a portfolio of the cartoons I have created [here](https://quixoticquartoons.carrd.co/).\
I am including this portfolio (despite it not being directly correlated with my technical writing experience) because it helps me stand out from other writers. It also demonstrates creativity in a way that is more impactful than just telling you that I am creative.
## Contact
